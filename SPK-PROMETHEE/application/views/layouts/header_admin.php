   ...
   <div id="wrapper">
     ...
     <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
       ...
       <div class="sidebar-brand-icon">
           <img src="<?= base_url('assets/') ?>img/kabmamasa.png" style="width: 60px;" type="image/x-icon">
         </div>
         <div class="sidebar-brand-text mx-2">Desa Salutambun Timur</div>
       </a>
      ...
      <!-- admin rkp                         -->
       <?php if ($this->session->userdata('id_user_level') == '3') : ?>
         ...
         <li class="nav-item <?php if ($page == 'Penilaian') {
           ...
           <a class="nav-link" href="<?= base_url('Penilaian'); ?>">
             <i class="fas fa-fw fa-edit"></i>
             <span>Penilaian Usulan RKP</span></a>
         </li>
