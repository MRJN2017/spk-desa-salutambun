...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Data Penilaian</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Kriteria <?= $r->keterangan ?> (<?= $r->kode_kriteria ?>)</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Total Indeks Preferensi</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Menghitung Indeks Preferensi</h6>
    </div>
				...
				<tbody>
					<?php 
						foreach ($alternatif as $baris) {
							$jumlah = 0 ;
							echo "<tr align='center'><th class='bg-primary text-white'>[$baris->kode_alternatif] $baris->nama</th>";
						...
						echo "<tr align='center'><th class='bg-primary text-white'>Jumlah</th>";
						foreach ($alternatif as $kolom) {
							echo "<td>".$jumlahaleternatif[$kolom->id_alternatif]."</td>";
						}
						echo "<td colspan='2'></td></tr>";

						echo "<tr align='center'><th class='bg-primary text-white'>Entering Flow</th>";
						foreach ($alternatif as $kolom) {
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-table"></i> Menghitung Leaving Flow, Entering Flow, Net Flow</h6>
    </div>
